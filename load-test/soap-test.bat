...
k6 run .\soap.js  -u 100 --summary-export=soapResults/soap5.json -e LOADPROFILE=media
...
k6 run .\soap.js  -u 100 --summary-export=soapResults/soap8.json -e LOADPROFILE=alta
